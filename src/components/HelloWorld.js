...
const HelloWorld = ({type}) => {
    if(type === 'tmpl'){ // will return simple templates
        return `<h1>this is simple hello world string returned from the page.</h1>`; //will be returned as string  &lt;h1&gt;hello&lt;/h1&gt;gt;
    }else if(type=== 'jsx'){
        return (
            <h1>hello world from JSX after babel-preset-react has been included !!!</h1>
        );
    }
    return React.createElement("html", null, React.createElement("head", null, React.createElement("title", null, "hello world!!!"), React.createElement("link", {
      ...
      }, React.createElement("h1", null, "hello world generated from Express JS using React Component!!"))));
}
